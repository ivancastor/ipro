...
# ====================================================================================
# NEW NAV BLOCK (same for servicos + quemSomos — Depoimentos links to index.html)
# ====================================================================================
$newNav = @'
      ...
      <nav class="hidden md:flex items-center gap-1">
        ...
        <!-- Nossa história -->
        <div class="nav-item">
          <a href="quemSomos.html" class="nav-icon-btn" aria-label="Nossa história">
            <img src="images/livro-aberto-capa.svg"    width="26" height="22" alt="">
          </a>
          <div class="nav-card"><img src="images/livro-aberto-capa.svg"    style="flex-shrink:0;" width="14" height="11" alt="">Nossa história</div>
        </div>
        <!-- Depoimentos -->
        <div class="nav-item">
...
# ====================================================================================
# NEW CSS BLOCK (to replace closing of nav-card CSS + </style>)
# ====================================================================================
$newCssBlock = @'
    .nav-item:hover .nav-card {
      opacity: 1;
...
# ====================================================================================
# NEW JS BLOCK (last part of <script> — year + mobile menu + scroll + observer)
# ====================================================================================
$newJsBlock = @'
...
# ====================================================================================
# MOBILE PANEL for servicos.html  (mob-active on Reparos)
# ====================================================================================
$mobilePanelServicos = @'
...
# ====================================================================================
# MOBILE PANEL for quemSomos.html  (mob-active on Nossa história)
# ====================================================================================
$mobilePanelQuem = @'
...
# ====================================================================================
# OLD CSS ENDING (same in servicos + quemSomos)
# ====================================================================================
$oldCssEnding = @'
    .nav-item:hover .nav-card {
      opacity: 1;
...
# ====================================================================================
# OLD JS BLOCK (same in servicos + quemSomos)
# ====================================================================================
$oldJsBlock = @'
    document.getElementById('year').textContent = new Date().getFullYear();
...
# 4. Replace mobile overlay + close header properly
